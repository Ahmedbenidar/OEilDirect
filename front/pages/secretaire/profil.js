        ...
        <header className="bg-white/50 backdrop-blur-md shadow-sm sticky top-0 z-50 flex items-center justify-between px-8 h-16 w-full">
          ...
          <div className="hidden md:flex items-center gap-8">
            <nav className="flex gap-6">
              <SameRouteScrollLink href="/secretaire" className="text-slate-500 font-medium hover:text-sky-600 text-sm">Tableau de bord</SameRouteScrollLink>
              <Link href="/secretaire/calendrier" className="text-slate-500 font-medium hover:text-sky-600 text-sm">Calendrier</Link>
              <Link href="/secretaire/patients" className="text-slate-500 font-medium hover:text-sky-600 text-sm">Patients</Link>
            ...
            <div className="flex items-center gap-4 border-l border-slate-200 pl-6">
              ...
              <Link href="/secretaire/profil" className="block">
                {user.photoProfil ? (
        ...
        <div className="flex">
          <aside className="hidden md:flex h-screen w-64 fixed left-0 top-0 pt-20 flex-col gap-2 p-4 bg-slate-100/50 border-r border-slate-200 z-40">
            <nav className="space-y-1">
              <SameRouteScrollLink href="/secretaire" className="flex items-center gap-3 py-3 px-4 text-slate-600 hover:bg-slate-200/50 mx-2 rounded-lg transition-all text-sm font-medium">
                <span className="material-symbols-outlined text-xl">dashboard</span>Tableau de bord
              </SameRouteScrollLink>
              <Link href="/secretaire/calendrier" className="flex items-center gap-3 py-3 px-4 text-slate-600 hover:bg-slate-200/50 mx-2 rounded-lg transition-all text-sm font-medium">
                <span className="material-symbols-outlined text-xl">calendar_month</span>Calendrier
              </Link>
              <Link href="/secretaire/patients" className="flex items-center gap-3 py-3 px-4 text-slate-600 hover:bg-slate-200/50 mx-2 rounded-lg transition-all text-sm font-medium">
          ...
          <main className="md:ml-64 p-8 pt-6 w-full">
            <ProfileForm roleRequis="SECRETAIRE" />
          </main>
        </div>
      </div>
    </>
